...
def qr():
    ...
    def contact():
        mess._show(title='Contact us', message="Please contact us on : randani143@rku.ac.in ")
    def about():
        mess._show(title='About', message="Created by Rahil")
    def ok():
...
def contact():
        mess._show(title='Contact us', message="Please contact us on :randani143@rku.ac.in")
def about():
        mess._show(title='About', message="Created QR Code Attendance System by Rahil\n")
...
Label(root, text="Welcome to Attendance System", font=('Aerial 15'), fg="blue",bg='LightBlue2').pack(pady=10)  
